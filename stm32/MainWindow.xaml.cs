...
namespace stm32
{
    public partial class MainWindow : Window
    {
        ...
        private void buttonLED1_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                dioda1.Fill = new SolidColorBrush(Colors.Black);
            }
            else
            {
                dioda1.Fill = new SolidColorBrush(Colors.Red);
            }
        }
        ...
        private void buttonLED2_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                dioda2.Fill = new SolidColorBrush(Colors.Black);
            }
            else
            {
                dioda2.Fill = new SolidColorBrush(Colors.Green);
            }
        }
        ...
        private void buttonLED3_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                dioda3.Fill = new SolidColorBrush(Colors.Black);
            }
            else
            {
                dioda3.Fill = new SolidColorBrush(Colors.Blue);
            }
        }
