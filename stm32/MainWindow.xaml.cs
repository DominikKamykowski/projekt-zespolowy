...
namespace stm32
{
 ...
 0xfa, 0xfd, 0xf4, 0xf3
        ...
        private byte[] CreateMessage(int ledNumber, bool ledState, int brightness)
        {
            byte[] message = new byte[9];
            message[0] = 0x60;
            message[1] = 0x60;
            message[2] = Convert.ToByte(ledState);
            message[3] = Convert.ToByte(ledState);
            message[4] = Convert.ToByte(ledState);
            message[5] = Convert.ToByte(brightness);
            message[6] = Convert.ToByte(brightness);
